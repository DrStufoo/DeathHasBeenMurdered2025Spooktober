...
public class AchievementManager : MonoBehaviour
{
    ...
    private bool achievement_thief;
    ...
    private void InitializeAchievements()
    {
        ...
        achievements.Add(new Achievement("Psycho", "Set your insanity to or above 1", (object o) => insanity >= 5));
        achievements.Add(new Achievement("Thief", "Steal the gold", (object o) => achievement_thief));
    }

    private void Update()
    {
        //Here's how to get a variable
        insanity = ((Ink.Runtime.IntValue) DialogueManager
        .GetInstance()
        .GetVariableState("insanity")).value;

        achievement_thief = ((Ink.Runtime.BoolValue) DialogueManager
        .GetInstance()
        .GetVariableState("achievement_thief")).value;
